...
export default class WeatherInformationView {
  ...
  rightNowElement() {
    ...
    this.icon.classList.add('wi');
    this.icon.classList.add('wi-na');
  ...
  updateForecast(forecast) {
    ...
    this.icon.classList.remove('wi-na');
    this.icon.classList.add(this.weatherClassFromIcon(forecast.currently.icon));
  }
